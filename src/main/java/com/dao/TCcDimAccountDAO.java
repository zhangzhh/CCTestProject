 ...
 * 
 * @see com.entity.TCcDimAccount
 * @author MyEclipse Persistence Tools
 */
public class TCcDimAccountDAO extends BaseHibernateDAO {
	...
	public TCcDimAccount findById(java.lang.Long id) {
		...
		try {
			TCcDimAccount instance = (TCcDimAccount) getSession().get(
					"com.entity.TCcDimAccount", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(TCcDimAccount instance) {
		...
		try {
			List results = getSession()
					.createCriteria("com.entity.TCcDimAccount")
	...
	public TCcDimAccount merge(TCcDimAccount detachedInstance) {
		...
		try {
			TCcDimAccount result = (TCcDimAccount) getSession().merge(
					detachedInstance);
