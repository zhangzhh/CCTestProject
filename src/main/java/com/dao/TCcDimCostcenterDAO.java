...
/**
 	* A data access object (DAO) providing persistence and search support for TCcDimCostcenter entities.
 ...
 */
public class TCcDimCostcenterDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TCcDimCostcenterDAO.class);
    ...
    public TCcDimCostcenter findById( String id) {
        log.debug("getting TCcDimCostcenter instance with id: " + id);
        try {
            TCcDimCostcenter instance = (TCcDimCostcenter) getSession()
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TCcDimCostcenter instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public TCcDimCostcenter merge(TCcDimCostcenter detachedInstance) {
        ...
        try {
            TCcDimCostcenter result = (TCcDimCostcenter) getSession()
