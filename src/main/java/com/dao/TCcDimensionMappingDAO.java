...
/**
 	* A data access object (DAO) providing persistence and search support for TCcDimensionMapping entities.
 ...
 */
public class TCcDimensionMappingDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TCcDimensionMappingDAO.class);
    ...
    public TCcDimensionMapping findById( java.lang.Long id) {
        ...
        try {
            TCcDimensionMapping instance = (TCcDimensionMapping) getSession()
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TCcDimensionMapping instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public TCcDimensionMapping merge(TCcDimensionMapping detachedInstance) {
        ...
        try {
            TCcDimensionMapping result = (TCcDimensionMapping) getSession()
