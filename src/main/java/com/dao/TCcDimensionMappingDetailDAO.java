...
/**
 	* A data access object (DAO) providing persistence and search support for TCcDimensionMappingDetail entities.
 ...
 */
public class TCcDimensionMappingDetailDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TCcDimensionMappingDetailDAO.class);
    ...
    public TCcDimensionMappingDetail findById( java.lang.Long id) {
        ...
        try {
            TCcDimensionMappingDetail instance = (TCcDimensionMappingDetail) getSession()
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TCcDimensionMappingDetail instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public TCcDimensionMappingDetail merge(TCcDimensionMappingDetail detachedInstance) {
        log.debug("merging TCcDimensionMappingDetail instance");
        try {
            TCcDimensionMappingDetail result = (TCcDimensionMappingDetail) getSession()
