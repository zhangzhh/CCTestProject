...
/**
 * TCcAccountbalance entity. @author MyEclipse Persistence Tools
 */

public class TCcAccountbalance implements java.io.Serializable {
	...
	/** default constructor */
	public TCcAccountbalance() {
	}

	/** minimal constructor */
	public TCcAccountbalance(Long id) {
		this.id = id;
	}

	/** full constructor */
	public TCcAccountbalance(Long id, Short year, Byte periodmonth,
