...
/**
 * TCcAccountbalanceBz entity. @author MyEclipse Persistence Tools
 */

public class TCcAccountbalanceBz implements java.io.Serializable {
	...
	/** default constructor */
	public TCcAccountbalanceBz() {
	}

	/** minimal constructor */
	public TCcAccountbalanceBz(Long id) {
		this.id = id;
	}

	/** full constructor */
	public TCcAccountbalanceBz(Long id, Short year, Byte periodmonth,
