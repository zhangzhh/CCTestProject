...
/**
 * TCcAccountbalanceDz entity. @author MyEclipse Persistence Tools
 */

public class TCcAccountbalanceDz implements java.io.Serializable {
	...
	/** default constructor */
	public TCcAccountbalanceDz() {
	}

	/** minimal constructor */
	public TCcAccountbalanceDz(Long id) {
		this.id = id;
	}

	/** full constructor */
	public TCcAccountbalanceDz(Long id, Short year, Byte periodmonth,
