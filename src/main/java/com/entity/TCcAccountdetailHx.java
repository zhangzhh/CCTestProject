...
/**
 * TCcAccountdetailHx entity. @author MyEclipse Persistence Tools
 */

public class TCcAccountdetailHx implements java.io.Serializable {
	...
	/** default constructor */
	public TCcAccountdetailHx() {
	}

	/** minimal constructor */
	public TCcAccountdetailHx(Long id) {
		this.id = id;
	}

	/** full constructor */
	public TCcAccountdetailHx(Long id, Long billmaindataid,
			Long billdetaildataid, String billno, String billtype, String memo,
			Long formid, Long structureid, Long requisitionuser,
			String dimcurrency, Double naturalcurrency, Double occurcurrentcy,
			String occurtype, Double balancecurrentcy, Long optiontypeid,
			String optiontypename, Timestamp happeneddate, Timestamp createdate) {
		this.id = id;
