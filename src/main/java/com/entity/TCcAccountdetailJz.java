...
/**
 * TCcAccountdetailJz entity. @author MyEclipse Persistence Tools
 */

public class TCcAccountdetailJz implements java.io.Serializable {
	...
	/** default constructor */
	public TCcAccountdetailJz() {
	}

	/** minimal constructor */
	public TCcAccountdetailJz(Long id) {
		this.id = id;
	}

	/** full constructor */
	public TCcAccountdetailJz(Long id, Long billmaindataid,
