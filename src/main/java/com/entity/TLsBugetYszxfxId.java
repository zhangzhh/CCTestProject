...
/**
 * TLsBugetYszxfxId entity. @author MyEclipse Persistence Tools
 */

public class TLsBugetYszxfxId implements java.io.Serializable {
	...
	/** default constructor */
	public TLsBugetYszxfxId() {
	}

	/** full constructor */
	public TLsBugetYszxfxId(Long parent0, Long structureid, BigDecimal buget,
			BigDecimal real, Long parent1, Long parent2, Long parent3,
			Long parent4, Long parent5, Long parent6, BigDecimal occupation) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TLsBugetYszxfxId))
			return false;
		TLsBugetYszxfxId castOther = (TLsBugetYszxfxId) other;
