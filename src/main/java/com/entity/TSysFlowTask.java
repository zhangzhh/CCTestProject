...
/**
 * TSysFlowTask entity. @author MyEclipse Persistence Tools
 */

public class TSysFlowTask implements java.io.Serializable {
	...
	/** minimal constructor */
	public TSysFlowTask(Long id) {
		this.id = id;
	}

	/** full constructor */
	public TSysFlowTask(Long id, Long taskid, String tasktitle,
			String tasklink, String rejectdirectinfo, String tasktype,
			String taskstatus, Timestamp taskcreatetime,
			Timestamp taskfinishtime, Long actorid, String actorname,
			Long actordeptid, String actordeptname, Long actorpostid,
			String actorpostname, String opinioncause, String opinionresult,
			String activityname, String processdefinitionname,
			String processdefinitionid, String processinstanceid,
			Timestamp processcreatetime, Long processinitiatorid,
			String processinitiatorname, Long fromtaskid,
			String fromactivityname, Long fromactorid, String fromactorname,
			Long boid, String bono, String boname, String botype,
			String bofield1, String bofield2, String bofield3, String bofield4,
			String bofield5, String bofield6, String bofield7, String bofield8,
			String bofield9, String bofield10, String bofield11,
			String bofield12, String bofield13, String bofield14,
			String bofield15, String remark, String executemodecount,
			BigDecimal branchId, Long agentactorid, String agentactorname) {
		this.id = id;
		this.taskid = taskid;
